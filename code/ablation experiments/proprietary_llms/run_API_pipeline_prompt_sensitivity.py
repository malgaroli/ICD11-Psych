...
def main():
    ...
    batch_size     = pipeline_params.get('batch_size', 16)
    max_new_tokens = pipeline_params.get('max_new_tokens', 512)
    
    #"gpt_4o", "gpt_51", "claude_opus46", "claude_sonnet46",  "gemini_25"
    ...
    results_folder_tmp = "results_versions"
    ...
    for version in ['v1','v2','v3']:
        ...
        for llm in llm_model: 
            ...
            results_folder = base_path.joinpath(results_folder_tmp,llm,version)
            ...
            prompt_id_version = f"{prompt_id}_{version}"
            prompt_builder = PromptBuilder(df_vignettes=data, prompts_path=prompt_path, prompt_id=prompt_id_version, language=language)
            ...
            evaluate_model_outputs(data, all_prompts, list_responses, index_mapping, llm, results_folder, prompt_id_version, language)
